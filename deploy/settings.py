...
ADMINS = (
    ('SaleCycle Operations Team', 'operations@salecycle.com'),
)
...
SERVER_EMAIL = 'ask@salecycle.com'
DEFAULT_FROM_EMAIL = 'ask@salecycle.com'
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER','')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD','')
EMAIL_SUBJECT_PREFIX = '[Ask SaleCycle] '
...
SECRET_KEY = '16969b2606333c7a0be5bef7a2838466'
...
MIDDLEWARE_CLASSES = (
    ...
    'askbot.middleware.remote_user.CustomHeaderMiddleware',
...
#    'askbot.deps.django_authopenid.backends.AuthBackend',
    'askbot.backends.remote_user.CustomRemoteUserBackend',
)
...
DOMAIN_NAME = 'ask.salecycle.com'

CSRF_COOKIE_NAME = 'ask.salecycle.com_csrf'
